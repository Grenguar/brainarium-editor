/**
 * Pure CSV parsing shared by the renderer's read-only preview and the main
 * process PDF exporter, so an exported table matches what was on screen.
 */
...
export const nonEmptyCells = (row: CsvRow): string[] =>
